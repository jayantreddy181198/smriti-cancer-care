    ...
    <div>
        <section className="main-banner">
            <div class="banner-text">
                <p class="banner-heading-2">Together We Fight Against Cancer</p>
                <p class="banner-heading-3">
                Providing hope, healing, and unwavering support to every individual touched by cancer. Join us in our mission to make a difference and create a brighter, healthier future for all.
                </p>
